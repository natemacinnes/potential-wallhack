...
import libraryserver.LibraryServerImplBase;
...
public class ReplicaServer extends Thread{
	...
	private HashMap<String,LibraryServerImplBase> serversMap;
	...
	public ReplicaServer(String replicaName)
	{
		...
		//TODO: modify LibraryServerInterface type
		serversMap = new HashMap<String,LibraryServerImplBase>();
	...
	private String startServers()
	{
		...
		serversMap.put("mcgill", new LibraryServerImplBase("localhost", 4442, "mcgill"));
		serversMap.put("uqam", new LibraryServerImplBase("localhost", 4443, "uqam"));
	...
	private String invokeReserveBook(String operation)
	{
		...
		result = serversMap.get(institution).reserveBook(username, password, bookTitle, authorName);
		return result;
	}
	...
	private String invokeGetNonReturners(String operation)
	{
		...
		try
		{
			...
			result = serversMap.get(institution).getNonreturners(adminUsername, adminPassword, institution, numDays);
			return result;
		}
		catch(NumberFormatException e)
		{
